...
*   libsodium: don't update config.sub, congig.guess from git.savannah.gnu.org by @DeckerSU in [https://github.com/KomodoPlatform/komodo/pull/635](https://github.com/KomodoPlatform/komodo/pull/635)

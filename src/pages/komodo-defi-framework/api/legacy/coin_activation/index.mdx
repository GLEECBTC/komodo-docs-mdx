...
<CodeGroup title="Electrum Method" tag="POST" label="electrum" mm2MethodDecorate="true" source="coin_activation.LegacyElectrumBch" />
...
<CodeGroup title="Electrum Method" tag="POST" label="electrum" mm2MethodDecorate="true" source="coin_activation.LegacyElectrumKmd" />
...
<CodeGroup title="Electrum Method" tag="POST" label="electrum" mm2MethodDecorate="true" source="coin_activation.LegacyElectrumQtum" />
...
<CodeGroup title="Enable Method" tag="POST" label="enable" mm2MethodDecorate="true" source="coin_activation.LegacyEnableNative" />
...
<CodeGroup title="" tag="POST" label="enable" mm2MethodDecorate="true" source="coin_activation.LegacyEnableNativeWithParams" />
...
<CodeGroup title="" tag="POST" label="enable" mm2MethodDecorate="true" source="coin_activation.LegacyEnableEth" />
...
<CodeGroup title="Enable Method" tag="POST" label="enable" mm2MethodDecorate="true" source="coin_activation.LegacyEnableEthGasStation" />
...
<CodeGroup title="Enable Method" tag="POST" label="enable" mm2MethodDecorate="true" source="coin_activation.LegacyEnableMatic" />
...
<CodeGroup title="Enable Method" tag="POST" label="enable" mm2MethodDecorate="true" source="coin_activation.LegacyEnableBnb" />

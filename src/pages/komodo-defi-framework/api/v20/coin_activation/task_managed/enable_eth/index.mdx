...
| path\_to\_address           | object           | Optional, HD wallets only. A standard [AddressPath](/komodo-defi-framework/api/common_structures/wallet/#address-path) object.                                                                                                                                                                                                               |
...
<CodeGroup title="task::enable_eth::init" tag="POST" label="task::enable_eth::init" mm2MethodDecorate="true" source="v2-coin-activation.TaskEnableEthInitTrezor" />
...
<CodeGroup title="task::enable_eth::status" tag="POST" label="task::enable_eth::status" mm2MethodDecorate="true" source="v2-coin-activation.TaskEnableEthStatus" />
...
<CodeGroup title="task::enable_eth::user_action" tag="POST" label="task::enable_eth::user_action" mm2MethodDecorate="true" source="v2-coin-activation.TaskEnableEthUserAction" />
...
<CodeGroup title="task::enable_eth::cancel" tag="POST" label="task::enable_eth::cancel" mm2MethodDecorate="true" source="v2-coin-activation.TaskEnableEthCancel" />

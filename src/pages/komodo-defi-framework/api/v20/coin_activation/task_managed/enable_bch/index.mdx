...
<CodeGroup title="task::enable_bch::init" tag="POST" label="task::enable_bch::init" mm2MethodDecorate="true" source="v2-coin-activation.TaskEnableBchInit" />
...
<CodeGroup title="task::enable_bch::status" tag="POST" label="task::enable_bch::status" mm2MethodDecorate="true" source="v2-coin-activation.TaskEnableBchStatus" />
...
<CodeGroup title="task::enable_bch::user_action" tag="POST" label="task::enable_bch::user_action" mm2MethodDecorate="true" source="v2-coin-activation.TaskEnableBchUserAction" />
...
<CodeGroup title="task::enable_bch::cancel" tag="POST" label="task::enable_bch::cancel" mm2MethodDecorate="true" source="v2-coin-activation.TaskEnableBchCancel" />

...
<CodeGroup title="task::enable_z_coin::init" tag="POST" label="task::enable_z_coin::init" mm2MethodDecorate="true" source="v2-coin-activation.TaskEnableZCoinInitBasic" />

#### Sync from block 2528700, with custom `.zcash-params` path and scan params

<CodeGroup title="task::enable_z_coin::init" tag="POST" label="task::enable_z_coin::init" mm2MethodDecorate="true" source="v2-coin-activation.TaskEnableZCoinInitWithSyncParams" />
...
<CodeGroup title="task::enable_z_coin::status" tag="POST" label="task::enable_z_coin::status" mm2MethodDecorate="true" source="v2-coin-activation.TaskEnableZCoinStatus" />
...
<CodeGroup title="task::enable_z_coin::user_action" tag="POST" label="task::enable_z_coin::user_action" mm2MethodDecorate="true" source="v2-coin-activation.TaskEnableZCoinUserAction" />
...
<CodeGroup title="task::enable_z_coin::cancel" tag="POST" label="task::enable_z_coin::cancel" mm2MethodDecorate="true" source="v2-coin-activation.TaskEnableZCoinCancel" />

...
<CodeGroup title="task::enable_qtum::init" tag="POST" label="task::enable_qtum::init" mm2MethodDecorate="true" source="v2-coin-activation.TaskEnableQtumInit" />
...
<CodeGroup title="task::enable_qtum::status" tag="POST" label="task::enable_qtum::status" mm2MethodDecorate="true" source="v2-coin-activation.TaskEnableQtumStatus" />
...
<CodeGroup title="task::enable_qtum::user_action" tag="POST" label="task::enable_qtum::user_action" mm2MethodDecorate="true" source="v2-coin-activation.TaskEnableQtumUserAction" />
...
<CodeGroup title="task::enable_qtum::cancel" tag="POST" label="task::enable_qtum::cancel" mm2MethodDecorate="true" source="v2-coin-activation.TaskEnableQtumCancel" />

...
<CodeGroup title="" tag="POST" label="enable_eth_with_tokens" mm2MethodDecorate="true" source="v2-coin-activation.EnableEthWithTokensGasStation" />
...
<CodeGroup title="" tag="POST" label="enable_eth_with_tokens" mm2MethodDecorate="true" source="v2-coin-activation.EnableEthWithTokensMaticBalancesFalse" />
...
<CodeGroup title="" tag="POST" label="enable_eth_with_tokens" mm2MethodDecorate="true" source="v2-coin-activation.EnableEthWithTokensMaticNft" />
...
<CodeGroup title="" tag="POST" label="enable_eth_with_tokens" mm2MethodDecorate="true" source="v2-coin-activation.EnableEthWithTokensWalletConnect" />

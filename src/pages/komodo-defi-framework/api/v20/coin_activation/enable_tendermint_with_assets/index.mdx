...
<CodeGroup title="" tag="POST" label="enable_tendermint_with_assets" mm2MethodDecorate="true" source="v2-coin-activation.EnableTendermintWithAssetsBalancesFalse" />
...
<CodeGroup title="" tag="POST" label="enable_tendermint_with_assets" mm2MethodDecorate="true" source="v2-coin-activation.EnableTendermintWithAssetsBalancesTrue" />
...
<CodeGroup title="" tag="POST" label="enable_tendermint_with_assets" mm2MethodDecorate="true" source="v2-coin-activation.EnableTendermintWithAssetsWalletConnect" />

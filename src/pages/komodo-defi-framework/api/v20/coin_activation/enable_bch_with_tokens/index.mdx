...
<CodeGroup title="" tag="POST" label="enable_bch_with_tokens" mm2MethodDecorate="true" source="v2-coin-activation.EnableBchWithTokensTxHistory" />
...
<CodeGroup title="" tag="POST" label="enable_bch_with_tokens" mm2MethodDecorate="true" source="v2-coin-activation.EnableBchWithTokensBalancesFalse" />

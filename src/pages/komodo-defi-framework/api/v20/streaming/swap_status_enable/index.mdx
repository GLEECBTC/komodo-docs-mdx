...
<CompactTable source="streaming.SwapStatusEnableRequestParameters" />

### Response Parameters

<CompactTable source="streaming.SwapStatusEnableResponseParameters" />
...
<CompactTable source="streaming.SwapStatusEnableErrorTypes" />

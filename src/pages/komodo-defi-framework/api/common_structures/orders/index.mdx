...
<CompactTable source="orders.1inchProtocolImage" />

### 1inchProtocolInfo

<CompactTable source="orders.1inchProtocolInfo" />

### 1inchTokenInfo

<CompactTable source="orders.1inchTokenInfo" variant="compact" />

### 1inchTxFields

<CompactTable source="orders.1inchTxFields" />

### CancelBy

<CompactTable source="orders.CancelBy" />
...
<CompactTable source="orders.ConfSettings" />
...
<CompactTable source="orders.ConfSettings_1" />
...
<CompactTable source="orders.ConfSettings_2" />
...
<CompactTable source="orders.OrderDataV1" />
### OrderDataV2
...
<CompactTable source="orders.OrderDataV2" />
### OrderStatusData

<CompactTable source="orders.OrderStatusData" variant="compact" />
...
<CompactTable source="orders.OrderDataV1_1" />
### OrderDataV2
...
<CompactTable source="orders.OrderDataV2_1" />
## OrderSummaryData

<CompactTable source="orders.OrderDataV2_2" />

### OrderType

<CompactTable source="orders.OrderType" />
...
<CompactTable source="orders.RequestBy" />
...
<CompactTable source="orders.PairDepth" />
...
<CompactTable source="orders.DepthInfo" />

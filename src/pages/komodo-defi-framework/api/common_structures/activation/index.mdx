...
<CompactTable source="activation.ActivationMode" />
...
<CompactTable source="activation.ActivationParams" />
...
<CompactTable source="activation.ActivationParams" variant="compact" />
...
<CompactTable source="activation.ActivationServers" variant="compact" />
...
<CompactTable source="activation.AddressInfo" />
...
<CompactTable source="activation.CoinProtocol" />

### CoinProtocolData

<CompactTable source="activation.CoinProtocolData" />

### CoinNode

The `CoinNode` object includes the following items for a given coin or token:

<CompactTable source="activation.CoinNode" />
...
<CompactTable source="activation.TokensRequest" />
...
<CompactTable source="activation.TokenActivationParams" />
...
<CompactTable source="activation.UtxoMergeParams" />

...
<CompactTable source="wallet.AccountAddressInfo" />
...
<CompactTable source="wallet.AccountAddressInfo_1" />
...
<CompactTable source="wallet.AddressInfo" />
...
<CompactTable source="wallet.AddressPath" />
...
<CompactTable source="wallet.BalanceInfo" />
...
<CompactTable source="wallet.DerivationMethod" />
...
<CompactTable source="wallet.ExtendedFeeInfo" />
...
<CompactTable source="wallet.FeeInfo" />
...
<CompactTable source="wallet.StakingDetails" />
...
<CompactTable source="wallet.StakingInfoDetails" />
...
<CompactTable source="wallet.ClaimingDetails" />
...
<CompactTable source="wallet.PrivKeyPolicy" />
...
<CompactTable source="wallet.RawTxInfo" />
...
<CompactTable source="wallet.ScanAddressesInfo" />
...
<CompactTable source="wallet.TotalFeeInfo" />
...
<CompactTable source="wallet.WithdrawFee" />
...
<CompactTable source="wallet.WalletAccountInfo" />
...
<CompactTable source="wallet.WalletBalanceInfo" />
...
<CompactTable source="wallet.WithdrawFromInfo" />

### AccountId

Identifier used across GUI-storage methods to reference a stored account.

<CompactTable source="wallet.AccountId" />
...
<CompactTable source="wallet.HdCoinKeys" />
...
<CompactTable source="wallet.HdKeysInfo" />
...
<CompactTable source="wallet.IguanaKeysInfo" />
<CollapsibleSection expandedText="Hide Examples" collapsedText="Show Examples">
...
<CompactTable source="wallet.NotSufficientBalance" />
...
<CompactTable source="wallet.AmountTooLow" />
#### InvalidAddress

The specified `to` address is not valid.

<CompactTable source="wallet.InvalidAddress" />
#### InvalidFeePolicy

The specified `fee` is not valid.

<CompactTable source="wallet.InvalidFeePolicy" />
...
<CompactTable source="wallet.AccruedRewards" />

### NotAccruedReason

Used in [kmd\_rewards\_info](/komodo-defi-framework/api/legacy/kmd_rewards_info/)

<CompactTable source="wallet.NotAccruedReason" />
<CollapsibleSection expandedText="Hide Examples" collapsedText="Show Examples">
...
<CompactTable source="wallet.EnabledAccountId" />
...
<CompactTable source="wallet.NewAccount" />

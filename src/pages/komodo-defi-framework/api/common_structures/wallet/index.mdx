...
| Parameter | Type   | Required | Description                                                                                                        |
| --------- | ------ | :------: | ------------------------------------------------------------------------------------------------------------------ |
| coin      | string |     ✓    | The ticker symbol of the coin.                                                                                     |
| addresses | array  |     ✓    | Array of [HdKeysInfo](/komodo-defi-framework/api/common_structures/wallet/#hd-keys-info) objects for each address. |
...
| ---------------- | ------ | :------: | ---------------------------------------------------------------------------------------------------------------- |
| derivation\_path | string |     ✓    | The [BIP44 derivation path](https://github.com/bitcoin/bips/blob/master/bip-0044.mediawiki) of the address.      |
| pubkey           | string |     ✓    | The public key for the address.                                                                                  |
| address          | string |     ✓    | The wallet address.                                                                                              |
| priv\_key        | string |     ✓    | The private key for the address.                                                                                 |
| viewing\_key     | string |     ✗    | The viewing key for the address. Only included for ZHTLC coins like ARRR that support enhanced privacy features. |
...
| --------- | ------ | :------: | -------------------------------- |
| coin      | string |     ✓    | The ticker symbol of the coin.   |
| pubkey    | string |     ✓    | The public key for the coin.     |
| address   | string |     ✓    | The wallet address for the coin. |
| priv\_key | string |     ✓    | The private key for the coin.    |

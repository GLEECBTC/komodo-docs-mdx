...
| balance          | map    | A map of [BalanceInfo](/komodo-defi-framework/api/common_structures/wallet/#balance-info) objects, sitting under their coin ticker. Platforms like ETH will may also return for balance info for activated tokens. |
...
#### UTXO response
  ...
  ```json
  {
      "address": "RU6M7iE1X1LddbmSfvsW66KQJmbAegePrJ",
